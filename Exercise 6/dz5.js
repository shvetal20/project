...
menu.insertBefore(menuItem[2], menuItem[1]);                          //Поменяли местами два елемента
...
title.textContent = "Мы продаем только подлинную технику Apple";      // Меняем текст

adv.remove();                                                         // Удаляем рекламу со страници
